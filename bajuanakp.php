  ...
  <div class="container">
    <div class="page-header_wrap">
      <div class="page-heading">
        <h1>Daftar Dekorasi</h1>
      </div>
      <ul class="coustom-breadcrumb">
        <li><a href="#">Home</a></li>
        <li>Daftar Dekorasi</li>
      </ul>
    </div>
  </div>
...
$sql = "SELECT id_baju FROM baju WHERE kategori='Dekorasi'";
...
<?php 
$sql1 = "SELECT baju.*,jenis.* FROM baju,jenis WHERE baju.id_jenis=jenis.id_jenis AND baju.kategori='Dekorasi'";
