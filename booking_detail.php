...
?>
	...
	<body>
		...
		<?php
		$kode = $_GET['kode'];
		$sql1 	= "SELECT booking.*,baju.*, jenis.* FROM booking,baju,jenis WHERE booking.id_baju=baju.id_baju AND baju.id_jenis=jenis.id_jenis AND booking.kode_booking='$kode' ORDER BY booking.createdAt DESC";
				...
				<div class="user_profile_info">
					<div class="col-md-12 col-sm-10">
						<form method="post" name="sewa" onSubmit="return valid();">
							...
							?>
								<b>*Silahkan transfer total biaya sewa ke BRI a/n Arrahma maksimal tanggal <?php echo IndonesiaTgl($tglhasil); ?>.
								<?php
							} else {
							} ?>
								</b>
