			...
			<table class="table table-borderless">
				<tbody>
					<tr>
						...
						<td class="text-center"><h3>ArrahmaWedding.com</h3></td>
						<td rowspan="3" width="16%">&nbsp;</td>
					</tr>
					<tr>
						<td class="text-center">Phone : +62 823-2275-3411 | E-mail : ask@arrahma.com</td>
					</tr>
					<tr>
			...
			<table class="table table-borderless">
				<tbody>
					...
					<?php
						...
						<tr>
							<td colspan='3'>
								<b>*Silahkan transfer total biaya sewa ke BRI a/n Arrahma maksimal tanggal "?> <?php echo IndonesiaTgl($tglhasil);?> <?php echo ".
							</td>
						</tr>
							";
						}else{
